...
public:
  ...
  std::vector<Frame*> getPlayerFrames(const std::string&);
  std::vector<Frame*> getEnemyFrames(const std::string&);
...
private:
  ...
  //player
  std::map<std::string, std::vector<SDL_Surface*> > playerSurfaces;
  //enemy
  std::map<std::string, std::vector<SDL_Surface*> > enemySurfaces;
  ...
  //player
  std::map<std::string, std::vector<Frame*> > playerFrames;
  //enemy
  std::map<std::string, std::vector<Frame*> > enemyFrames;
  FrameFactory() : 
